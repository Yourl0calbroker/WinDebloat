<#
.NOTES
    Author         : Yourl0calbroker

    GitHub         : https://github.com/Yourl0calbroker/WinDebloat
    Version        : 26.04.14
#>
...
if (!([Security.Principal.WindowsPrincipal][Security.Principal.WindowsIdentity]::GetCurrent()).IsInRole([Security.Principal.WindowsBuiltInRole]::Administrator)) {
    Write-Output "WinDebloat needs to be run as Administrator. Attempting to relaunch."
    $argList = @()
    ...
    $script = if ($PSCommandPath) {
        ...
        "&([ScriptBlock]::Create((irm https://raw.githubusercontent.com/Yourl0calbroker/WinDebloat/main/winutil.ps1))) $($argList -join ' ')"
    }
...
$Host.UI.RawUI.WindowTitle = "WinDebloat (Admin)"
clear-host
...
function Invoke-WinUtilInstallPSProfile {
    <#
    .SYNOPSIS
        Installs a community PowerShell 7 profile with oh-my-posh and useful aliases.
    #>

    if ($PSVersionTable.PSVersion.Major -lt 7) {
        [System.Windows.MessageBox]::Show(
            "PowerShell 7 or later is required for this profile.`nPlease install PowerShell 7 first (available in the Install tab).",
            "WinDebloat", [System.Windows.MessageBoxButton]::OK, [System.Windows.MessageBoxImage]::Warning)
        return
    }

    Write-Host "Installing Community PowerShell Profile..." -ForegroundColor Cyan

    if (Test-Path $Profile) {
        $backup = $Profile + '.windebloat.bak'
    ...
    $profileContent = @'
# WinDebloat Community PowerShell Profile
...
function uptime {
    ...
    "Up {0}d {1}h {2}m" -f $up.Days, $up.Hours, $up.Minutes
}
...
'@
    ...
    Write-Host "Community PowerShell Profile installed. Restart your terminal to apply." -ForegroundColor Green
}
...
function Invoke-WinUtilISOModify {
    ...
    $script.AddScript({
        ...
        try {
            ...
            Log "Applying WinDebloat modifications to install.wim..."
...
function Invoke-WinUtilISOCheckExistingWork {
    ...
    [System.Windows.MessageBox]::Show(
        "A previous WinDebloat ISO working directory was found:`n`n$($existingWorkDir.FullName)`n`n(Last modified: $modified)`n`nStep 4 (output options) has been restored so you can save the already-modified image.`n`nClick 'Clean & Reset' in Step 4 if you want to start over.",
...
function Invoke-WinUtilISOScript {
    ...
    .NOTES
        Author  : Yourl0calbroker
        GitHub  : https://github.com/Yourl0calbroker
    #>
    param (
...
function Invoke-WinUtilUninstallPSProfile {
    ...
    Write-Host "Successfully removed the WinDebloat PowerShell profile." -ForegroundColor Green
}
...
function Show-CustomDialog {
    ...
    $winutilTextBlock.Text = "WinDebloat"
...
function Invoke-WPFButton {
    ...
    #[System.Windows.MessageBox]::Show("$Button","WinDebloat","OK","Info")
...
function Invoke-WPFFeatureInstall {
    ...
    if($sync.ProcessRunning) {
        ...
        [System.Windows.MessageBox]::Show($msg, "WinDebloat", [System.Windows.MessageBoxButton]::OK, [System.Windows.MessageBoxImage]::Warning)
        return
    }
        ...
        "export" {
            try {
                ...
                if ($Config) {
                    ...
                    "iex ""& { `$(irm https://raw.githubusercontent.com/Yourl0calbroker/WinDebloat/main/winutil.ps1) } -Config '$Config'""" | Set-Clipboard
                }
            } catch {
...
function Invoke-WPFUIElements {
    ...
    foreach ($panelKey in ($organizedData.Keys | Sort-Object)) {
        ...
        foreach ($category in ($organizedData[$panelKey].Keys | Sort-Object)) {
            ...
            }}, @{Expression = { if ($_.Order) { [int]$_.Order } else { 9999 } }}, Content
...
function Invoke-WPFUltimatePerformance {
    ...
    if ($Do) {
        if (-not (powercfg /list | Select-String "WinDebloat - Ultimate Power Plan")) {
            ...
            powercfg /changename $guid "WinDebloat - Ultimate Power Plan"
            ...
            Write-Host "WinDebloat - Ultimate Power Plan plan installed and activated." -ForegroundColor Green
        } else {
            Write-Host "WinDebloat - Ultimate Power Plan plan is already installed." -ForegroundColor Red
            return
        }
    } else {
        if (powercfg /list | Select-String "WinDebloat - Ultimate Power Plan") {
            powercfg /setactive SCHEME_BALANCED
            powercfg /delete ((powercfg /list | Select-String "WinDebloat - Ultimate Power Plan").ToString().Split()[3])
            Write-Host "WinDebloat - Ultimate Power Plan plan was removed." -ForegroundColor Red
        } else {
            Write-Host "WinDebloat - Ultimate Power Plan plan is not installed." -ForegroundColor Yellow
        }
    }
}
...
$sync.configs.feature = @'
{
  "WPFFeaturesdotnet": {
    ...
    "InvokeScript": [],
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/features/features/dotnet"
  },
  "WPFFixesNTPPool": {
    ...
    "ButtonWidth": "300",
    "function": "Invoke-WPFFixesNTPPool",
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/features/fixes/ntppool"
  },
  "WPFFeatureshyperv": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/features/features/hyperv"
  },
  "WPFFeatureslegacymedia": {
    ...
    "InvokeScript": [],
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/features/features/legacymedia"
  },
  "WPFFeaturewsl": {
    ...
    "InvokeScript": [],
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/features/features/wsl"
  },
  "WPFFeaturenfs": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/features/features/nfs"
  },
  "WPFFeatureRegBackup": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/features/features/regbackup"
  },
  "WPFFeatureEnableLegacyRecovery": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/features/features/enablelegacyrecovery"
  },
  "WPFFeatureDisableLegacyRecovery": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/features/features/disablelegacyrecovery"
  },
  "WPFFeaturesSandbox": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/features/features/sandbox"
  },
  "WPFFeatureInstall": {
    ...
    "ButtonWidth": "300",
    "function": "Invoke-WPFFeatureInstall",
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/features/features/install"
  },
  "WPFPanelAutologin": {
    ...
    "ButtonWidth": "300",
    "function": "Invoke-WPFPanelAutologin",
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/features/fixes/autologin"
  },
  "WPFFixesUpdate": {
    ...
    "ButtonWidth": "300",
    "function": "Invoke-WPFFixesUpdate",
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/features/fixes/update"
  },
  "WPFFixesNetwork": {
    ...
    "ButtonWidth": "300",
    "function": "Invoke-WPFFixesNetwork",
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/features/fixes/network"
  },
  "WPFPanelDISM": {
    ...
    "ButtonWidth": "300",
    "function": "Invoke-WPFSystemRepair",
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/features/fixes/dism"
  },
  "WPFFixesWinget": {
    ...
    "ButtonWidth": "300",
    "function": "Invoke-WPFFixesWinget",
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/features/fixes/winget"
  },
  "WPFPanelControl": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/features/legacy-windows-panels/control"
  },
  "WPFPanelComputer": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/features/legacy-windows-panels/computer"
  },
  "WPFPanelNetwork": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/features/legacy-windows-panels/network"
  },
  "WPFPanelPower": {
    "Content": "Power Panel",
    "category": "Legacy Windows Panels",
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/features/legacy-windows-panels/power"
  },
  "WPFPanelPrinter": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/features/legacy-windows-panels/printer"
  },
  "WPFPanelRegion": {
    "Content": "Region",
    "category": "Legacy Windows Panels",
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/features/legacy-windows-panels/region"
  },
  "WPFPanelRestore": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/features/legacy-windows-panels/restore"
  },
  "WPFPanelSound": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/features/legacy-windows-panels/sound"
  },
  "WPFPanelSystem": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/features/legacy-windows-panels/system"
  },
  "WPFPanelTimedate": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/features/legacy-windows-panels/timedate"
  },
  "WPFWinUtilInstallPSProfile": {
    "Content": "Install Community PowerShell Profile",
    "category": "Powershell Profile Powershell 7+ Only",
    "panel": "2",
    "Type": "Button",
    "ButtonWidth": "300",
    "function": "Invoke-WinUtilInstallPSProfile",
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/features/powershell-profile-powershell-7--only/installpsprofile"
  },
  "WPFWinUtilUninstallPSProfile": {
    "Content": "Uninstall Community PowerShell Profile",
    "category": "Powershell Profile Powershell 7+ Only",
    "panel": "2",
    "Type": "Button",
    "ButtonWidth": "300",
    "function": "Invoke-WinUtilUninstallPSProfile",
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/features/powershell-profile-powershell-7--only/uninstallpsprofile"
  },
  "WPFWinUtilSSHServer": {
    ...
    "ButtonWidth": "300",
    "function": "Invoke-WPFSSHServer",
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/features/remote-access/sshserver"
  }
}
'@ | ConvertFrom-Json
$sync.configs.preset = @'
{
  "Standard": [
    ...
    "WPFTweaksDisableSearchHighlights",
    "WPFTweaksDisableSuggestedActions",
    "WPFTweaksDisableLockScreenAds",
    "WPFTweaksDisableDeliveryOptimization",
    "WPFTweaksDisableAutoPlay",
    "WPFTweaksDisableCortana"
  ],
  "Minimal": [
    "WPFTweaksConsumerFeatures",
    "WPFTweaksWPBT",
...
$sync.configs.themes = @'
{
  "shared": {
    ...
    "GroupBorderBackgroundColor": "#1E2227",
    "ButtonFontSize": "12",
  ...
  "Light": {
    ...
    "ProgressBarForegroundColor": "#0078D4",
    ...
    "ButtonBackgroundPressedColor": "#005A9E",
    "ButtonBackgroundMouseoverColor": "#D4E8F8",
    "ButtonBackgroundSelectedColor": "#F0F0F0",
    "ButtonForegroundColor": "#232629",
    "ToggleButtonOnColor": "#00B4D8",
  ...
  "Dark": {
    "AppInstallUnselectedColor": "#1E2227",
    "AppInstallHighlightedColor": "#2D3139",
    "AppInstallSelectedColor": "#00B4D8",
    "AppInstallOverlayBackgroundColor": "#2E3135",
    "ComboBoxForegroundColor": "#F7F7F7",
    "ComboBoxBackgroundColor": "#252A31",
    "LabelboxForegroundColor": "#00D4FF",
    "MainForegroundColor": "#F7F7F7",
    "MainBackgroundColor": "#1A1D21",
    "LabelBackgroundColor": "#1A1D21",
    "LinkForegroundColor": "#5DD8F0",
    "LinkHoverForegroundColor": "#F7F7F7",
    "ScrollBarBackgroundColor": "#2D3139",
    "ScrollBarHoverColor": "#3B4252",
    "ScrollBarDraggingColor": "#00B4D8",
    "ProgressBarForegroundColor": "#00B4D8",
    "ProgressBarBackgroundColor": "Transparent",
    "ProgressBarTextColor": "#232629",
    "ButtonInstallBackgroundColor": "#1E2227",
    "ButtonTweaksBackgroundColor": "#1E2227",
    "ButtonConfigBackgroundColor": "#1E2227",
    "ButtonUpdatesBackgroundColor": "#1E2227",
    "ButtonWin11ISOBackgroundColor": "#1E2227",
    ...
    "ButtonBackgroundColor": "#252A31",
    "ButtonBackgroundPressedColor": "#00B4D8",
    "ButtonBackgroundMouseoverColor": "#2D3547",
    "ButtonBackgroundSelectedColor": "#00B4D8",
    "ButtonForegroundColor": "#F7F7F7",
    "ToggleButtonOnColor": "#00B4D8",
    "ToggleButtonOffColor": "#707070",
    "ToolTipBackgroundColor": "#252A31",
    "BorderColor": "#3A3F47",
    "BorderOpacity": "0.2"
  }
}
...
$sync.configs.tweaks = @'
{
  "WPFTweaksActivity": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/essential-tweaks/activity"
  },
  "WPFTweaksHiber": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/essential-tweaks/hiber"
  },
  "WPFTweaksWidget": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/essential-tweaks/widget"
  },
  "WPFTweaksRevertStartMenu": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/essential-tweaks/revertstartmenu"
  },
  "WPFTweaksDisableStoreSearch": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/essential-tweaks/disablestoresearch"
  },
  "WPFTweaksLocation": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/essential-tweaks/location"
  },
  "WPFTweaksServices": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/essential-tweaks/services"
  },
  "WPFTweaksBraveDebloat": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/z--advanced-tweaks---caution/bravedebloat"
  },
  "WPFTweaksEdgeDebloat": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/z--advanced-tweaks---caution/edgedebloat"
  },
  "WPFTweaksConsumerFeatures": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/essential-tweaks/consumerfeatures"
  },
  "WPFTweaksTelemetry": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/essential-tweaks/telemetry"
  },
  "WPFTweaksRemoveEdge": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/z--advanced-tweaks---caution/removeedge"
  },
  "WPFTweaksUTC": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/z--advanced-tweaks---caution/utc"
  },
  "WPFTweaksRemoveOneDrive": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/z--advanced-tweaks---caution/removeonedrive"
  },
  "WPFTweaksRemoveHome": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/z--advanced-tweaks---caution/removehome"
  },
  "WPFTweaksRemoveGallery": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/z--advanced-tweaks---caution/removegallery"
  },
  "WPFTweaksDisplay": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/z--advanced-tweaks---caution/display"
  },
  "WPFTweaksXboxRemoval": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/z--advanced-tweaks---caution/xboxremoval"
  },
  "WPFTweaksDeBloat": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/z--advanced-tweaks---caution/debloat"
  },
  "WPFTweaksRestorePoint": {
    "Content": "Create Restore Point",
    "Description": "Creates a restore point at runtime in case a revert is needed from WinDebloat modifications.",
    "category": "Essential Tweaks",
    "panel": "1",
    "Checked": "False",
    "registry": [
    ...
    "InvokeScript": [
      "\r\n      if (-not (Get-ComputerRestorePoint)) {\r\n          Enable-ComputerRestore -Drive $Env:SystemDrive\r\n      }\r\n\r\n      Checkpoint-Computer -Description \"System Restore Point created by WinDebloat\" -RestorePointType MODIFY_SETTINGS\r\n      Write-Host \"System Restore Point Created Successfully\" -ForegroundColor Green\r\n      "
    ],
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/essential-tweaks/restorepoint"
  },
  "WPFTweaksEndTaskOnTaskbar": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/essential-tweaks/endtaskontaskbar"
  },
  "WPFTweaksPowershell7Tele": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/essential-tweaks/powershell7tele"
  },
  "WPFTweaksStorage": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/z--advanced-tweaks---caution/storage"
  },
  "WPFTweaksRemoveCopilot": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/z--advanced-tweaks---caution/removecopilot"
  },
  "WPFTweaksWPBT": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/essential-tweaks/wpbt"
  },
  "WPFTweaksRazerBlock": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/z--advanced-tweaks---caution/razerblock"
  },
  "WPFTweaksDisableNotifications": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/z--advanced-tweaks---caution/disablenotifications"
  },
  "WPFTweaksBlockAdobeNet": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/z--advanced-tweaks---caution/blockadobenet"
  },
  "WPFTweaksRightClickMenu": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/z--advanced-tweaks---caution/rightclickmenu"
  },
  "WPFTweaksDiskCleanup": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/essential-tweaks/diskcleanup"
  },
  "WPFTweaksDeleteTempFiles": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/essential-tweaks/deletetempfiles"
  },
  "WPFTweaksIPv46": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/z--advanced-tweaks---caution/ipv46"
  },
  "WPFTweaksTeredo": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/z--advanced-tweaks---caution/teredo"
  },
  "WPFTweaksDisableIPv6": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/z--advanced-tweaks---caution/disableipv6"
  },
  "WPFTweaksDisableBGapps": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/z--advanced-tweaks---caution/disablebgapps"
  },
  "WPFTweaksDisableFSO": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/z--advanced-tweaks---caution/disablefso"
  },
  "WPFToggleDarkMode": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/customize-preferences/darkmode"
  },
  "WPFToggleBingSearch": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/customize-preferences/bingsearch"
  },
  "WPFToggleStandbyFix": {
    ...
    "registry": [
      {
        "Path": "HKLM:\\SYSTEM\\CurrentControlSet\\Control\\Power\\PowerSettings\\f15576e8-98b7-4186-b944-eafa664402d9",
        "Name": "ACSettingIndex",
        "Value": "0",
        "Type": "DWord",
        "OriginalValue": "<RemoveEntry>",
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/customize-preferences/standbyfix"
  },
  "WPFToggleNumLock": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/customize-preferences/numlock"
  },
  "WPFToggleVerboseLogon": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/customize-preferences/verboselogon"
  },
  "WPFToggleStartMenuRecommendations": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/customize-preferences/startmenurecommendations"
  },
  "WPFToggleHideSettingsHome": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/customize-preferences/hidesettingshome"
  },
  "WPFToggleMouseAcceleration": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/customize-preferences/mouseacceleration"
  },
  "WPFToggleStickyKeys": {
    "Content": "Sticky Keys",
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/customize-preferences/stickykeys"
  },
  "WPFToggleNewOutlook": {
    "Content": "New Outlook",
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/customize-preferences/newoutlook"
  },
  "WPFToggleMultiplaneOverlay": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/customize-preferences/multiplaneoverlay"
  },
  "WPFToggleHiddenFiles": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/customize-preferences/hiddenfiles"
  },
  "WPFToggleShowExt": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/customize-preferences/showext"
  },
  "WPFToggleTaskbarSearch": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/customize-preferences/taskbarsearch"
  },
  "WPFToggleTaskView": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/customize-preferences/taskview"
  },
  "WPFToggleTaskbarAlignment": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/customize-preferences/taskbaralignment"
  },
  "WPFToggleDetailedBSoD": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/customize-preferences/detailedbsod"
  },
  "WPFToggleS3Sleep": {
    "Content": "S3 Sleep",
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/customize-preferences/s3sleep"
  },
  "WPFchangedns": {
    "Content": "DNS",
    "category": "z__Advanced Tweaks - CAUTION",
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/z--advanced-tweaks---caution/changedns"
  },
  "WPFAddUltPerf": {
    ...
    "Type": "Button",
    "ButtonWidth": "300",
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/performance-plans/addultperf"
  },
  "WPFRemoveUltPerf": {
    ...
    "Type": "Button",
    "ButtonWidth": "300",
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/performance-plans/removeultperf"
  },
  "WPFTweaksDisableExplorerAutoDiscovery": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/essential-tweaks/disableexplorerautodiscovery"
  },
  "WPFToggleDisableCrossDeviceResume": {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/customize-preferences/disablecrossdeviceresume"
  }
  ,
  "WPFTweaksDisableRecall": {
    "Content": "Disable Windows Recall (AI Snapshots)",
    "Description": "[Windows 11 24H2+] Disables Windows Recall, which periodically takes AI-powered screenshots of your screen to build a searchable activity history. A serious privacy risk.",
    "category": "z__Advanced Tweaks - CAUTION",
    "panel": "1",
    "InvokeScript": [
      "\r\n      $policyPath = 'HKLM:\\SOFTWARE\\Policies\\Microsoft\\Windows\\WindowsAI'\r\n      if (-not (Test-Path $policyPath)) { New-Item -Path $policyPath -Force | Out-Null }\r\n      Set-ItemProperty -Path $policyPath -Name 'DisableAIDataAnalysis' -Value 1 -Type DWord\r\n      Set-ItemProperty -Path $policyPath -Name 'AllowRecallEnablement' -Value 0 -Type DWord\r\n      $recallSvc = 'AiCubeService'\r\n      if (Get-Service $recallSvc -ErrorAction SilentlyContinue) {\r\n        Stop-Service $recallSvc -Force -ErrorAction SilentlyContinue\r\n        Set-Service $recallSvc -StartupType Disabled\r\n      }\r\n      Get-AppxPackage -AllUsers *MicrosoftWindows.Client.AIX* | Remove-AppxPackage -AllUsers -ErrorAction SilentlyContinue\r\n      Write-Host 'Windows Recall disabled.' -ForegroundColor Green\r\n      "
    ],
    "UndoScript": [
      "\r\n      $policyPath = 'HKLM:\\SOFTWARE\\Policies\\Microsoft\\Windows\\WindowsAI'\r\n      Remove-ItemProperty -Path $policyPath -Name 'DisableAIDataAnalysis' -ErrorAction SilentlyContinue\r\n      Remove-ItemProperty -Path $policyPath -Name 'AllowRecallEnablement' -ErrorAction SilentlyContinue\r\n      Write-Host 'Windows Recall policy removed. Re-enable Recall from Settings > Privacy & Security > Recall.' -ForegroundColor Yellow\r\n      "
    ],
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/z--advanced-tweaks---caution/disablerecall"
  },
  "WPFTweaksDisableCopilotKey": {
    "Content": "Remap Copilot Key (24H2+)",
    "Description": "[Windows 11 24H2+] Remaps the dedicated Copilot key on new keyboards so it no longer launches Copilot. The key becomes inert until you assign a new shortcut in Settings > Personalization > Text input.",
    "category": "Customize Preferences",
    "panel": "1",
    "InvokeScript": [
      "\r\n      $keyPath = 'HKCU:\\Software\\Microsoft\\Input\\Settings'\r\n      if (-not (Test-Path $keyPath)) { New-Item -Path $keyPath -Force | Out-Null }\r\n      Set-ItemProperty -Path $keyPath -Name 'IsF23KeyboardShortcutEnabled' -Value 0 -Type DWord\r\n      Write-Host 'Copilot key remapped. It will no longer launch Copilot.' -ForegroundColor Green\r\n      "
    ],
    "UndoScript": [
      "\r\n      $keyPath = 'HKCU:\\Software\\Microsoft\\Input\\Settings'\r\n      if (Test-Path $keyPath) { Remove-ItemProperty -Path $keyPath -Name 'IsF23KeyboardShortcutEnabled' -ErrorAction SilentlyContinue }\r\n      Write-Host 'Copilot key restored to default behavior.' -ForegroundColor Yellow\r\n      "
    ],
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/customize-preferences/disablecopilotkey"
  },
  "WPFTweaksDisableAdvertisingID": {
    "Content": "Disable Advertising ID",
    "Description": "Turns off the unique advertising ID Windows uses to track you across apps for personalized ads. Apps will no longer use this ID to build a profile of your activity.",
    "category": "Essential Tweaks",
    "panel": "1",
    "registry": [
      {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/essential-tweaks/disableadvertisingid"
  },
  "WPFTweaksDisableStartupBoost": {
    "Content": "Disable Edge & Outlook Startup Boost",
    "Description": "Stops Microsoft Edge and the New Outlook from preloading background processes at every boot. Saves RAM and reduces startup time.",
    "category": "Performance Plans",
    "panel": "1",
    "registry": [
      {
    ...
    "InvokeScript": [
      "\r\n      $outlookPath = 'HKCU:\\Software\\Microsoft\\Office\\16.0\\Outlook\\Options\\General'\r\n      if (-not (Test-Path $outlookPath)) { New-Item -Path $outlookPath -Force | Out-Null }\r\n      Set-ItemProperty -Path $outlookPath -Name 'DisableOutlookBoost' -Value 1 -Type DWord -ErrorAction SilentlyContinue\r\n      Write-Host 'Edge and Outlook startup boost disabled.' -ForegroundColor Green\r\n      "
    ],
    "UndoScript": [
      "\r\n      $outlookPath = 'HKCU:\\Software\\Microsoft\\Office\\16.0\\Outlook\\Options\\General'\r\n      if (Test-Path $outlookPath) { Remove-ItemProperty -Path $outlookPath -Name 'DisableOutlookBoost' -ErrorAction SilentlyContinue }\r\n      Write-Host 'Outlook startup boost restored.' -ForegroundColor Yellow\r\n      "
    ],
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/performance-plans/disablestartupboost"
  },
  "WPFTweaksDisableSearchHighlights": {
    "Content": "Disable Search Highlights",
    "Description": "Disables the daily trending topics, web news and ads shown in Windows Search. Speeds up search and reduces distractions.",
    "category": "Essential Tweaks",
    "panel": "1",
    "registry": [
      {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/essential-tweaks/disablesearchhighlights"
  },
  "WPFTweaksDisableSuggestedActions": {
    "Content": "Disable Suggested Actions",
    "Description": "Disables the clipboard Suggested Actions pop-up that appears when you copy a phone number, date, or URL and Windows offers to open related apps.",
    "category": "Essential Tweaks",
    "panel": "1",
    "registry": [
      {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/essential-tweaks/disablesuggestedactions"
  },
  "WPFTweaksDisableLockScreenAds": {
    "Content": "Disable Lock Screen Tips and Ads",
    "Description": "Removes the fun facts, tips, tricks, and sponsored spotlight ads shown on the Windows lock screen.",
    "category": "Essential Tweaks",
    "panel": "1",
    "registry": [
      {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/essential-tweaks/disablelockscreenads"
  },
  "WPFTweaksDisableDeliveryOptimization": {
    "Content": "Disable Delivery Optimization Uploads",
    "Description": "Stops Windows Update Delivery Optimization from using your internet bandwidth to upload Windows updates to other PCs on the internet. Downloads from LAN peers are still allowed.",
    "category": "Essential Tweaks",
    "panel": "1",
    "InvokeScript": [
      "\r\n      $doSettings = 'HKLM:\\SOFTWARE\\Policies\\Microsoft\\Windows\\DeliveryOptimization'\r\n      if (-not (Test-Path $doSettings)) { New-Item -Path $doSettings -Force | Out-Null }\r\n      Set-ItemProperty -Path $doSettings -Name 'DODownloadMode' -Value 1 -Type DWord\r\n      Write-Host 'Delivery Optimization set to LAN-only. No more uploading to random internet PCs.' -ForegroundColor Green\r\n      "
    ],
    "UndoScript": [
      "\r\n      $doSettings = 'HKLM:\\SOFTWARE\\Policies\\Microsoft\\Windows\\DeliveryOptimization'\r\n      Remove-ItemProperty -Path $doSettings -Name 'DODownloadMode' -ErrorAction SilentlyContinue\r\n      Write-Host 'Delivery Optimization restored to default.' -ForegroundColor Green\r\n      "
    ],
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/essential-tweaks/disabledeliveryoptimization"
  },
  "WPFTweaksDisableWER": {
    "Content": "Disable Windows Error Reporting",
    "Description": "Stops Windows from sending crash data, error reports, and diagnostic info to Microsoft. Also silences crash-report dialog boxes.",
    "category": "z__Advanced Tweaks - CAUTION",
    "panel": "1",
    "registry": [
      {
    ...
    "UndoScript": [
      "\r\n      Set-Service WerSvc -StartupType Manual -ErrorAction SilentlyContinue\r\n      Write-Host 'Windows Error Reporting service re-enabled (Manual).' -ForegroundColor Green\r\n      "
    ],
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/z--advanced-tweaks---caution/disablewer"
  },
  "WPFTweaksDisableAutoPlay": {
    "Content": "Disable AutoPlay",
    "Description": "Prevents Windows from automatically launching programs or prompting when you plug in a USB drive, disc, or other removable media. Improves security against autorun-based malware.",
    "category": "Essential Tweaks",
    "panel": "1",
    "registry": [
      {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/essential-tweaks/disableautoplay"
  },
  "WPFTweaksDisableFastStartup": {
    "Content": "Disable Fast Startup",
    "Description": "Disables Fast Startup (Hybrid Boot). Fast Startup saves a partial hibernate state instead of fully shutting down, which can cause dual-boot issues, prevent driver updates from applying, and mask hardware problems.",
    "category": "z__Advanced Tweaks - CAUTION",
    "panel": "1",
    "registry": [
      {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/z--advanced-tweaks---caution/disablefaststartup"
  },
  "WPFTweaksDisablePhoneLink": {
    "Content": "Remove Phone Link",
    "Description": "Removes the Phone Link (Your Phone) app which syncs your Android or iOS device with Windows. Also removes the Phone Link icon from the taskbar.",
    "category": "z__Advanced Tweaks - CAUTION",
    "panel": "1",
    "appx": [
      "Microsoft.YourPhone",
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/z--advanced-tweaks---caution/disablephonelink"
  },
  "WPFTweaksDisableCortana": {
    "Content": "Disable Cortana",
    "Description": "Disables Cortana search integration and removes the Cortana app package. Cortana is largely replaced by Windows Copilot in Windows 11 but still runs background processes on some systems.",
    "category": "Essential Tweaks",
    "panel": "1",
    "registry": [
      {
    ...
    "link": "https://github.com/Yourl0calbroker/WinDebloat/blob/main/docs/tweaks/essential-tweaks/disablecortana"
  }
}
'@ | ConvertFrom-Json
$inputXML = @'
        ...
        <Grid Grid.Row="1" Background="{DynamicResource MainBackgroundColor}">
            ...
            <Grid Name="GridBesideNavDockPanel" Grid.Column="1" Background="{DynamicResource MainBackgroundColor}" ShowGridLines="False" Height="Auto">
                ...
                <Border Grid.Column="0" Margin="5,0,0,0" Width="{DynamicResource SearchBarWidth}" Height="{DynamicResource SearchBarHeight}" VerticalAlignment="Center" HorizontalAlignment="Left">
                    <Grid>
                        <TextBox
                            ...
                            Padding="3,3,30,0"
                            ToolTip="Search apps by name or description. Press Ctrl+F to focus. Press Esc to clear the search.">
                        </TextBox>
                        <TextBlock
                ...
                <StackPanel Grid.Column="1" Orientation="Horizontal" HorizontalAlignment="Right" VerticalAlignment="Top" Margin="5,5,5,5">
                    ...
                    FontFamily="Segoe MDL2 Assets"
                    Content="N/A"
                    ToolTip="Change the WinDebloat UI Theme"
                />
                ...
                />
                    ...
                    <Border Background="{DynamicResource MainBackgroundColor}" BorderBrush="{DynamicResource MainForegroundColor}" BorderThickness="1" CornerRadius="0" Margin="0">
                        <StackPanel Background="{DynamicResource MainBackgroundColor}" HorizontalAlignment="Stretch" VerticalAlignment="Stretch">
                            ...
                            <MenuItem FontSize="{DynamicResource ButtonFontSize}" Header="GitHub" Name="SponsorMenuItem" Foreground="{DynamicResource MainForegroundColor}"/>
                        </StackPanel>
                    </Border>
                </Popup>
...
$brandText.Text = "WinDebloat"
$brandText.FontSize = 16
$brandText.FontWeight = "Bold"
$brandText.FontFamily = "Segoe UI"
$brandText.VerticalAlignment = "Center"
$brandText.Margin = "6,0,0,0"
$brandText.SetResourceReference([Windows.Controls.TextBlock]::ForegroundProperty, "LabelboxForegroundColor")
...
$sync["AboutMenuItem"].Add_Click({
    ...
    $authorInfo = @"
Tool     : WinDebloat - Windows Utility Tool
Author   : <a href="https://github.com/Yourl0calbroker">@Yourl0calbroker</a>
GitHub   : <a href="https://github.com/Yourl0calbroker/WinDebloat">Yourl0calbroker/WinDebloat</a>
Version  : <a href="https://github.com/Yourl0calbroker/WinDebloat/releases">$($sync.version)</a>
Run      : irm https://raw.githubusercontent.com/Yourl0calbroker/WinDebloat/main/winutil.ps1 | iex
"@
...
$sync["DocumentationMenuItem"].Add_Click({
    ...
    Invoke-WPFPopup -Action "Hide" -Popups @("Settings")
    Start-Process "https://github.com/Yourl0calbroker/WinDebloat"
})
$sync["SponsorMenuItem"].Add_Click({
    Write-Debug "GitHub clicked"
    Invoke-WPFPopup -Action "Hide" -Popups @("Settings")
    Start-Process "https://github.com/Yourl0calbroker/WinDebloat"
})
